...
import (
	...
	dStub "code.in.spdigital.sg/sp-digital/migrate/v4/database/stub"
	"code.in.spdigital.sg/sp-digital/migrate/v4/source"
	sStub "code.in.spdigital.sg/sp-digital/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "code.in.spdigital.sg/sp-digital/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "code.in.spdigital.sg/sp-digital/migrate/v4/source/stub"`
